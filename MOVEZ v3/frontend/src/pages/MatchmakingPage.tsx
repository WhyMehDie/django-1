...
const SOLO_PLAYERS = [
  ...
  },
  {
    ...
    bio: 'Marathonienne en herbe ! Cherche partenaire de footing matinal',
  },
  {
  ...
  return (
    <div className="matchmaking-container">
      ...
      {challengeModal && (
        <div className="match-modal-overlay">
          <div className="match-modal glass">
            <h2 className="match-modal-title" style={{ color: '#f59e0b' }}>Défier l'équipe</h2>
            ...
            <div className="match-modal-actions">
              ...
              <button className="btn-primary" style={{ background: '#f59e0b', color: '#000' }} onClick={() => { alert('Défi lancé !'); setChallengeModal(null); }}>Lancer le défi</button>
            </div>
          </div>
        </div>
      )}
